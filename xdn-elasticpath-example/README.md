...
Read more information about deploying Elastic Path on XDN [here](deploying-Elastic-Path-on-XDN.md)
...
- build elastic app: `yarn build`
- build xdn app: `yarn xdn:build`

## Run

- run xdn app: `yarn xdn:start:prod`

## Deploy

- deploy xdn app: `yarn xdn:deploy`

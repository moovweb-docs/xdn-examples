...
- The second command will build XDN files in `.xdn`, `dist-xdn-*` folders
- For the next builds it's recommended to run `yarn xdn:clean` before running `yarn xdn:build`
